    ...
    <div className="group relative bg-white rounded-2xl border border-[#E5E0D8] hover:border-[#B9A77A] product-card-hover overflow-hidden flex flex-col justify-between h-full">
      ...
      >
        ...
        <img
          ...
          alt={product.title}
          className="w-full h-full object-contain p-1 sm:p-2 rounded-xl img-editorial drop-shadow-md group-hover/img:scale-105 transition-transform duration-500 bg-black"
          loading="lazy"
        />
